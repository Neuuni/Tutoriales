...
4. Una ves añadida la información de la clase, como siguiente paso asegúrate de tener activada la opción de "Unirme con Google Meet".
...
1. Haz clic en la opción señalada como se indica en la imagen.

![sincro](./img/L10.jpg)

2. Haz clic en la opcion de "gestionar grabación".

![sincro](./img/L11.jpg)

3. Nos aparecera la siguiente ventana en la cual daremos clic en la opción de "iniciar grabación".

![sincro](./img/L12.jpg)

4. Al dar clic en la opcion anterior se nos habilitara la siguiente vista en la cual seleccionamos la opción de iniciar.
...
1. Selecciona los paso como se indica en la imagen, dando clic como primer paso en el apartado de configuración de la reunion y grupos de trabajo.
...
4. Presiona la siguiente opcion de los tres puntitos se te desplegara la siguiente ventana, selecciona "compartir"

![sincro](./img/L23.jpg)

5. En la nueva ventana que le aparece ingrese el correo de:
- la.lopez@unineuuni.edu.mx
