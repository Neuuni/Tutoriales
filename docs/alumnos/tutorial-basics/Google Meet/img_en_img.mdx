...
<div style={{ backgroundColor: '#D9EDF7', border: '1px solid #0047bb', padding: '10px', borderRadius: '4px', display: 'flex', justifyContent: 'left', alignItems: 'center', boxShadow: '4px 4px 0px 0px rgba(0, 71, 187, 0.5)'  }}>
  ...
  <div style={{ textAlign: 'left' }}>
    📌 <strong>Consejos profesionales:</strong> <br />
    <ul>
      <li>Usa esta función cuando necesites consultar materiales mientras moderas la clase</li>
      <li>Combínala con el compartido de pantalla para presentaciones fluidas</li>
      <li>Ideal para verificar mensajes del chat sin perder de vista a los participantes</li>
    </ul>
  </div>
