...
Contar con un repositorio institucional te ofrece ventajas clave:
    ...
    - **Información Verificada**: Acceso a fuentes oficiales y académicas..
...
Para apoyar tu aprendizaje, el sitio alberga diversos tipos de recursos:
    ...
    - **Libros:** Textos de consulta académica y bibliografía clave para fundamentar teóricamente tu investigación.
    - **Herramientas estadísticas:** Manuales, guías prácticas e indicadores documentados para el correcto procesamiento y análisis de tus datos.
    - **Instrumentos de investigación:** Tests validados, guías de evaluación y otros documentos listos para aplicar en tu recolección de datos.
...
Si encuentras un documento útil y quieres consultarlo después sin tener que buscarlo de nuevo, puedes añadirlo a la sección *Favoritos*:

    - Dentro el documento que deseas guardar, haz clic en el botón ***♥ Agregar a favoritos***.

<Card>
    ![likeresearch](./img/nr5.png)
    ___
    *Haz clic en el botón para guardar el archivo*
</Card>

    - El archivo se guardará automáticamente en tu sección de **Favoritos**, ubicada en el menú principal, para un acceso inmediato.

<Card>
    ![favoritosresearch](./img/nr8.png)
    ___
...
<VideoIntro title="Acceso a la plataforma NEUUNI" videoUrl="https://www.youtube.com/embed/ny8woCaFg3I?si=qjg08S7nspCV3QGJ" />