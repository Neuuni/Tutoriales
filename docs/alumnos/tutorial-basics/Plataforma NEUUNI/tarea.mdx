...
#### Nota: Recuerda que parte de la actividad es realizada en la clase sincrónica y la otra parte de manera individual.
...
Una vez que hayas seleccionado el archivo o ingresado el enlace, verás disponible el botón Enviar al mentor. Para tu comodidad, este botón se encuentra ubicado en dos secciones de la pantalla:

- En la parte superior derecha de la barra de navegación.

- En la parte inferior derecha, justo debajo del editor de texto.

Al hacer clic en cualquiera de ellos, el archivo se enviará directamente al mentor para su evaluación.
